...
//  // Áp dụng AdminInterceptor cho tất cả // các đường dẫn bắt đầu với /admin
//  
//  registry.addInterceptor(employerInterceptor).addPathPatterns("/job4u/employers"); // Áp dụng EmployerInterceptor cho /job4u/employers } 
//  }
  @Configuration
  public class WebConfig implements WebMvcConfigurer {
