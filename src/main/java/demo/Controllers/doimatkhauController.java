...
public class doimatkhauController {
	...
	@PostMapping("/submit")
	public String doiMatKhau(RedirectAttributes redirectAttributes, @RequestParam("oldPassword") String oldPassword,
		...
		try {
			...
			// Kiểm tra mật khẩu mới ít nhất 8 ký tự và chứa ít nhất một số và một chữ cái
