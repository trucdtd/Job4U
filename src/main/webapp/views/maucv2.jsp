...
<div class="container">
					...
					<div class="section">
						<div class="section-title">Liên Hệ</div>
						 ...
						 <input class="hidden-input" type="text"
							name="phone" required value="099876554"> <input class="hidden-input" type="date" name="dob" required>
						 <select
							class="hidden-input" name="gender" id="gender" required>
							<option value="nam">Nam</option>
							<option value="nu">Nữ</option>
						</select> <input class="hidden-input" type="text"
							name="languages" required value="Ngôn Ngữ">
							 <input class="hidden-input" type="text"
							name="address" required value="Địa Chỉ">
					</div>
    ...
    <div id="education">
        <div class="education-container">
            <input class="hidden-input project-name" type="text" name="education[]" placeholder="Tên Trường" required>
            <input class="hidden-input" type="text" name="education[]" placeholder="Thời Gian" required>
            <textarea class="hidden-input" name="education[]" placeholder="Mô Tả" required></textarea>
        </div>
    </div>
	...
	<script>
		...
		function addEducation() {
		    ...
		    schoolNameInput.placeholder = "Tên Trường";
