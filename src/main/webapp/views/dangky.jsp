							...
							<form action="/DangKy/submit" method="post"
								...
								<div class="row">
									<div class="col">
										<label class="form-label" for="fullname">Họ và Tên</label> <input
											...
											class="form-control" placeholder="Nhập họ và tên" /> <span
											class="text-danger" id="fullnameError">${fullnameError}</span>
									</div>
									<div class="col">
										<label class="form-label" for="username">Tên Tài Khoản</label>
										<input type="text" id="username" name="username"
											class="form-control" placeholder="Nhập tên tài khoảng" /> <span
											class="text-danger" id="usernameError">${usernameError}</span>
									</div>
								</div>
								...
								<div class="row">
									<div class="col">
										<label class="form-label" for="email">Email</label> <input
											...
											placeholder="Nhập email" /> <span class="text-danger"
											id="emailError">${emailError}</span>
									</div>
									<div class="col">
										<label class="form-label" for="numberphone">Số Điện
											Thoại</label> <input type="text" id="numberphone" name="numberphone"
											class="form-control" placeholder="Nhập số điện thoại" /> <span
											class="text-danger" id="numberphoneError">${numberphoneError}</span>
									</div>
								</div>
								...
								<div class="mb-4">
									<label class="form-label" for="password">Mật Khẩu</label> <input
										...
										class="text-danger" id="passwordError">${passwordError}</span>
								</div>
									...
									<div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="usertype"
												...
												onchange="toggleEmployerDetails()"> <label
									...
									<div class="row">
										<div class="col">
											<label for="companyName" class="form-label">Tên Công
												...
												name="companyName"> <span class="text-danger"
												id="companyNameError">${companyNameError}</span>
										</div>
										<div class="col">
											<label for="companyWebsite" class="form-label">Website
												Công Ty</label> <input type="text" class="form-control"
												id="companyWebsite" name="companyWebsite"> <span
												class="text-danger" id="companyWebsiteError">${companyWebsiteError}</span>
										</div>
									</div>
									<div class="row">
										<div class="col">
											<label for="companyAddress" class="form-label">Địa
												Chỉ</label> <input type="text" class="form-control"
												id="companyAddress" name="companyAddress"> <span
												class="text-danger" id="companyAddressError">${companyAddressError}</span>
										</div>
										<div class="col">
											...
											</select> <span class="text-danger" id="industryError">${industryError}</span>
										</div>
									</div>
									<div class="row">
										<div class="col">
											<label for="contactPerson" class="form-label">Người
												...
												id="contactPerson" name="contactPerson"> <span
												class="text-danger" id="contactPersonError">${contactPersonError}</span>
										</div>
										<div class="col">
								...
								<div class="text-center text-lg-start mt-4 pt-2">
									...
									<p class="small fw-bold mt-2 pt-1 mb-0">
										Bạn đã có tài khoản? <a href="/job4u/Login"
