						...
						<form id="reportForm" action="/chiTiet/${jobid}/report"
							...
							<div class="mb-3">
								...
								<textarea class="form-control" id="reason" name="reason"
									rows="3" placeholder="Nhập lý do báo cáo ở đây"></textarea>
							</div>
							...
							<div class="form-check">
								<input type="checkbox" class="form-check-input" id="reason1"
									name="reason"
									value="Bài viết tuyển dụng chứa thông tin sai lệch, không chính xác, gây nhầm lẫn cho ứng viên.">
								<label class="form-check-label" for="reason1">Bài viết
									tuyển dụng chứa thông tin sai lệch, không chính xác, gây nhầm
									lẫn cho ứng viên.</label>
							</div>
							<div class="form-check">
								<input type="checkbox" class="form-check-input" id="reason2"
									name="reason"
									value="Công việc hoặc công ty được mô tả không có thật hoặc lừa đảo.">
								<label class="form-check-label" for="reason2">Công việc
									hoặc công ty được mô tả không có thật hoặc lừa đảo.</label>
							</div>
							<div class="form-check">
								<input type="checkbox" class="form-check-input" id="reason3"
									name="reason"
									value="Tài khoản hoặc công ty giả mạo lừa đảo trên Job4U.">
								<label class="form-check-label" for="reason3">Tài khoản
									hoặc công ty giả mạo lừa đảo trên Job4U.</label>
							</div>
							...
							<!-- Submit button -->
							<button type="submit" class="btn btn-danger w-100 mt-3">Gửi
								báo cáo</button>
						</form>
					</div>
				</div>
