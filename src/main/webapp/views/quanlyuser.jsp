	...
	<div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-md-3">
                <div class="p-3 text-white bg-dark">
                    <a href="#" class="d-flex align-items-center mb-3 mb-md-0 text-white text-decoration-none">
                        ...
                        <span class="fs-4">Menu User Management</span>
                    </a>
                    <hr>
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li class="nav-item">
                            <a href="#" class="nav-link active" aria-current="page" onclick="showTable(event, 'home')">
                        ...
                        <li>
                            <a href="#" class="nav-link text-white" onclick="showTable(event, 'userManagement')">
                                <svg class="bi me-2" width="16" height="16">
                        ...
                        <li>
                            <a href="#" class="nav-link text-white" onclick="showTable(event, 'postManagement')">
                                <svg class="bi me-2" width="16" height="16">
                        ...
                        <li>
                            <a href="#" class="nav-link text-white" onclick="showTable(event, 'cvManagement')">
                                <svg class="bi me-2" width="16" height="16">
            ...
            <div class="col-md-9">
                ...
                <div id="userManagement" class="card mb-4" style="display: none;">
                    <div class="card-header">
                ...
                <div id="postManagement" class="card mb-4" style="display: none;">
                    <div class="card-header">
                ...
                <!-- CV Management table -->
                <div id="cvManagement" class="card mb-4" style="display: none;">
                    <div class="card-header">
