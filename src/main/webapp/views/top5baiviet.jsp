				...
				<c:forEach var="job" items="${latestJobs}" varStatus="status">
					<div class="carousel-item ${status.index == 0 ? 'active' : ''}">
						<div class="image-container">
							<img src="/img/jobforyou.jpg" class="d-block w-100" alt="Slide ${status.index + 1}">
						</div>
						<div class="carousel-caption d-none d-md-block">
							<div class="card p-2">
								<div class="row">
									<h4 class="m-t-0 m-b-0">
										<strong>${job.jobtitle}</strong> <!-- Cập nhật tên công ty -->
									</h4>
									<span class="job_post">${job.jobdescription}</span>
