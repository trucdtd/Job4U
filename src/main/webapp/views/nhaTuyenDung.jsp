			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="p-4" action="/job4u/employers/update" method="post" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6 p-2">
								...
								<div class="col-md-6 p-2">
									<label for="companywebsite" class="form-label">Tên web
										...
										id="companywebsite" name="companywebsite" readonly>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 p-2">
							...
							<div class="row">
								...
								<div class="col-md-6 p-2">
									<label for="salary" class="form-label">Lương</label>
									<div class="input-group">
										<span class="input-group-text">VND</span> <input type="number"
							...
							<div class="row">
								<div class="col-md-12 p-2">
									<label for="companydescription" class="form-label">Mô
										tả về công ty</label>
									<textarea class="form-control" id="companydescription"
										name="companydescription" rows="4" readonly></textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 p-2">
            ...
            button.addEventListener('click', function () {
                ...
                fetch(`/job4u/employers/${jobId}`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById('posteddate').value = data.posteddate;
                        document.getElementById('applicationdeadline').value = data.applicationdeadline;
