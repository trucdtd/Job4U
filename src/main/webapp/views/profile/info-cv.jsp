...
<body>
	<div class="container mt-5">
		...
		<form:form method="post" action="/user/cv"
			...
			<div class="mb-3 row">
				<div class="col">
					<label for="emailcv">Email cá nhân:</label> <input
						class="form-control" id="emailcv" name="emailcv"
						placeholder="tencuaban@examole.com" required></input>
				</div>
				<div class="col">
					<label for="phonenumbercv">Phone cá nhân:</label> <input
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="experience" name="experience"
					placeholder="Mô tả kinh nghiệm làm việc của bạn & Vị trí" rows="4"></textarea>
			</div>

			<div class="mb-3">
				<label for="education">Học vấn:</label>
				<textarea class="form-control" id="education" name="education"
					placeholder="Tên trường, ngành học & thời gian bắt đầu, kết thức"
					rows="4"></textarea>
			</div>
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="languages" name="languages"
					placeholder="Nêu trình độ ngôn ngữ của bạn" rows="5"></textarea>
			</div>

			<div class="mb-3">
				<label for="interests">Sở thích:</label>
				<textarea class="form-control" id="interests" name="interests"
					placeholder="Điền các sở thích của bạn" rows="4"></textarea>
			</div>
