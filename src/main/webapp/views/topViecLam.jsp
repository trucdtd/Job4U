            ...
            <div class="top-jobs-container">
                ...
                <c:forEach var="job" items="${topJobs}">
                    <div class="top-job-item">
                        ...
                        <a href="/job4u/chiTiet/${job.jobid}" class="btn btn-outline-primary btn-sm">Xem chi tiết</a>
                    </div>
                </c:forEach>
            </div>
        </div>
    ...
    <section style="background-color: #eee;">
        <div class="container py-4">
            <div class="row justify-content-center">
                ...
                <c:if test="${not empty dsSP.content}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                                            <div class="bg-image hover-zoom ripple rounded ripple-surface">
                                                <img src="${job.employer.logo}" class="w-100" alt="${job.employer.companyname}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                            <div class="d-flex flex-column mt-4">
                                                <a href="/applyCV" class="btn btn-primary btn-sm">Ứng tuyển</a>
