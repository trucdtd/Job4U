                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form action="/Login/submit" method="post">
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                ...
                                <input type="text" id="form3Example3" class="form-control form-control-lg" placeholder="Tài khoản" name="username" />
                            </div>
                            ...
                            <div data-mdb-input-init class="form-outline mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" id="form3Example4" class="form-control form-control-lg" placeholder="Mật khẩu" name="password" />
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-success btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Đăng nhập</button>
                                <p class="small fw-bold mt-2 pt-1 mb-0">
                                    Bạn chưa có tài khoản? <a href="/DangKy" class="link-danger">Đăng ký</a>
                                </p>
                            </div>
                        </form>
                    </div>
