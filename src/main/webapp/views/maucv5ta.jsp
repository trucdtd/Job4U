...
<body>
		...
		<div class="left-panel" id="sortable-left">
			<div class="image-container">
				<input type="file" id="profileImage" accept="image/*"
					onchange="previewImage(event)" class="image-input"> <img
					id="profilePreview" src="https://via.placeholder.com/150"
					alt="Profile Picture" class="img-fluid rounded-circle" width="150"
					height="150">
			</div>
			<div class="section" class="contact-info">
				<h3 class="section-title">Contact</h3>
				<input class="hidden-input" type="text" name="phone"
					placeholder="Phone Number"> <input class="hidden-input"
					type="email" name="email" placeholder="Email"> <input
					type="text" class="hidden-input" name="address"
					placeholder="Address"> <input class="hidden-input"
					type="date" placeholder="Date of Birth" id="dateOfbirth"
					class="input-field"> <select class="hidden-input"
					name="gender">
					<option value="" disabled selected>Gender</option>
					<option value="male">Male</option>
					<option value="female">Female</option>
					<option value="other">Other</option>
				</select> <input class="hidden-input" type="text" name="language"
			...
			<div class="section" class="certification"
				id="certifications-section">
				<h3 class="section-title">Certifications</h3>
				<div id="certifications-list">
					<div class="input-group">
						<input class="hidden-input" type="text" name="certification[]"
		...
		<div class="right-panel" id="sortable-right">
			<div class="personal-info">
				...
				<textarea class="hidden-input" name="career-objective"
					placeholder="I am a creative, hardworking individual always striving for excellence in everything I do. I am a quick learner and always look for ways to improve the lives of those around me."
					required></textarea>
			</div>
			<div class="section" id="education-section">
				...
				<div id="education-list">
					<!-- Example Entry -->
					<div class="input-group">
						<input class="hidden-input project-name" type="text" name="education_name[]"
							placeholder="School Name"> <input class="hidden-input"
							type="text" name="education_time[]" placeholder="Time Period">
						<textarea class="hidden-input" name="education_description[]"
				...
				<div id="projects-list">
					<div class="input-group">
						<input class="hidden-input project-name" type="text"
							name="project_name[]" placeholder="Project Name"> <input
							class="hidden-input" type="text" name="project_time[]"
							placeholder="Time Period">
						<textarea class="hidden-input" name="project_description[]"
    ...
    function addSkill() {
        ...
        newSkill.innerHTML = '<input class="hidden-input" type="text" name="skills[]" placeholder="Skills">';
    ...
    function addCertification() {
        ...
        newCertification.innerHTML = '<input class="hidden-input" type="text" name="certification[]" placeholder="Certification">';
    ...
    function addEducation() {
        ...
        newEducation.innerHTML = `
            <input class="hidden-input project-name" type="text" name="education_name[]" placeholder="School Name">
            <input class="hidden-input" type="text" name="education_time[]" placeholder="Time">
            <textarea class="hidden-input" name="education_description[]" placeholder="Description" rows="3"></textarea>
        `;
    ...
    function addProject() {
        ...
        newProject.innerHTML = `
            <input class="hidden-input project-name" type="text" name="project_name[]" placeholder="Project">
            <input class="hidden-input" type="text" name="project_time[]" placeholder="Time">
            <textarea class="hidden-input" name="project_description[]" placeholder="Description" rows="3"></textarea>
        `;
    ...
    function addHobby() {
        ...
        newHobby.innerHTML = '<input class="hidden-input" type="text" name="hobbies[]" placeholder="Hobby">';
