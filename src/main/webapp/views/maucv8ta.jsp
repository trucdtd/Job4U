...
<body>
	...
	<div class="cv-container" id="cv-content">
		<div class="left-column" id="sortable-left">
			...
			<div class="contact section">
				...
				<input class="hidden-input" type="text" placeholder="Address"
			...
			<div class="skills section">
				...
				<div id="skills-container">
					<input class="hidden-input" type="text" id="skills"
						class="input-field" placeholder="Skills">
			...
			<div class="certifications section">
				...
				<div id="certifications-container">
					<input class="hidden-input" type="text" id="certifications"
						class="input-field" placeholder="Certificate">
		...
		<div class="right-column" id="sortable-right">
			...
			<div class="experience section">
				...
				<div id="experience-container">
					<textarea class="hidden-input" id="experience"
						placeholder="I am a creative, cheerful, and hardworking person who strives for excellence in everything I do. I am a curious learner always looking for ways to improve the lives of those around me."></textarea>
				</div>
			</div>
				...
				<div id="education-container">
					<div class="education-field">
						<input class="hidden-input project-name" type="text"
							...
							placeholder="Dates">
						<textarea class="hidden-input input-area" placeholder="Description"></textarea>
					</div>
			...
			<div class="projects section">
				<div class="section-title">Projects Participated In</div>
			...
			<div class="hobbies section">
				...
				<div id="hobbies-container">
					<input class="hidden-input" type="text" id="hobbies"
						class="input-field" placeholder="Hobbies">
	...
	<script>
		...
		function addCertificationField() {
			...
			newField.type = 'text';
			newField.className = 'input-field hidden-input';
			newField.placeholder = 'Certifications';
		...
		function addProjectField() {
			...
			projectTime.placeholder = 'Time';

			const projectDescription = document.createElement('textarea');
			projectDescription.className = 'input-area hidden-input';
			projectDescription.placeholder = 'Descripcation';
