		...
		<div class="container">
			...
			<div class="right-section">
				...
				<div class="section">
					...
					<div class="job">
						<p id="aboutMeContent">Tôi có hơn 5 năm kinh nghiệm trong lĩnh
							vực tiếp thị và quản lý các chiến lược kinh doanh.</p>
					</div>
				</div>
				...
				<div class="section">
					...
					<div class="job">
						...
						<p>
							<strong id="job1Time">2022 - 2023</strong>
						</p>
						<p id="job1Company">Arrowhead Industries</p>
						<p id="job1Desc">Phụ trách triển khai chiến lược tiếp thị,
							quản lý nhóm và đạt được mục tiêu doanh số.</p>
					</div>
					<div class="job">
						<h3 id="job2Title">Quản Lý Tiếp Thị</h3>
						<p>
							<strong id="job2Time">2020 - 2021</strong>
						</p>
						<p id="job2Company">Gingerleaf International Co.</p>
						<p id="job2Desc">Phát triển các chiến dịch tiếp thị sáng tạo,
							mở rộng thương hiệu và tăng doanh thu.</p>
					</div>
				</div>
				<div class="section">
					...
					<div class="job">
						...
						<p>
							<strong id="education1Time">2019 - 2022</strong>
						</p>
						<p id="education1Desc">Cử nhân Quản trị Kinh doanh với thành
							tích xuất sắc.</p>
					</div>
					<div class="job">
						<h3 id="education2Title">Đại học Borcelle</h3>
						<p>
							<strong id="education2Time">2016 - 2018</strong>
						</p>
						<p id="education2Desc">Cử nhân Quản trị Kinh doanh với chuyên
							ngành Tiếp thị.</p>
					</div>
				</div>
			</div>
		...
		document.getElementById("language").addEventListener("change",
				function() {
					...
					if (selectedLanguage === "vi") {
						link.href = "/luaCV/mauCV8"; // Mẫu CV tiếng Việt
					} else if (selectedLanguage === "en") {
						link.href = "/luaCV/mauCV8ta"; // Mẫu CV tiếng Anh
					}
				});
