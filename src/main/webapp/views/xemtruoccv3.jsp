...
<body>
	<div class="cv-wrapper">
		...
		<div class="resume-container">
			...
			<div class="left-column">
				...
				<div class="reference">
					<h2 class="section-title" data-key="reference-title">Tham
						chiếu</h2>
			...
			<div class="right-column">
				<div class="personal-info">
					...
					<p data-key="summary">Tôi là một người sáng tạo chăm chỉ, luôn
						...
						và tìm cách cải thiện cuộc sống của những người xung quanh.</p>
				</div>

				<h2 class="section-title" data-key="education-title">Học vấn</h2>
				<ul>
					<li data-key="education1"><strong>Đại học Great</strong><br>Thạc
						sĩ Thiết kế Sản phẩm<br>2010 - 2013</li>
					<li data-key="education2"><strong>Đại học Great</strong><br>Cử
						nhân Phân tích Kỹ thuật số<br>2008 - 2010</li>
					<li data-key="education3"><strong>Đại học Great</strong><br>Cử
						nhân Thiết kế Đồ họa<br>2006 - 2008</li>
				</ul>

				<h2 class="section-title" data-key="experience-title">Kinh
					nghiệm</h2>
				<ul>
					<li data-key="experience1"><strong>Quản lý Thời trang
							Cấp cao</strong><br>2007 - Hiện tại<br>Làm việc với các thương
						hiệu thời trang hàng đầu</li>
					<li data-key="experience2"><strong>Nhà báo Thời trang</strong><br>2007
						- 2008<br>Phụ trách nội dung xuất bản cho nhiều thương hiệu</li>
				</ul>
			</div>
		</div>
    ...
    document.getElementById("language").addEventListener("change", function() {
        ...
        if (selectedLanguage === "vi") {
            link.href = "/luaCV/mauCV3";  // Mẫu CV tiếng Việt
