...
<body>
		...
		<nav class="container navbar navbar-expand-lg"
			...
			<div class="container-fluid">
					...
					<div class="offcanvas-body">
						<ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
							...
							<li class="nav-item"><a class="nav-link" href="/job4u">Top
									Công Việc</a></li>
							<li class="nav-item"><a id="employers-link" class="nav-link"
								href="/job4u/employers">Nhà Tuyển Dụng</a></li>
							<li class="nav-item"><a id="apply-link" class="nav-link"
								href="#">Ứng Tuyển</a></li>
						</ul>

						<div id="login-register-buttons">
							<a id="login-btn" href="/Login"
								class="btn login-button text-center"><img
						...
						<div id="account-info"
							...
							<button class="btn btn-light btn-light-custom" type="button"
								id="dropdownMenuButton" data-bs-toggle="dropdown"
								aria-expanded="false">
								<img class="text-center" src="/img/icons8-bell-48.png"
									height="30px" alt=""> <span id="user-name"
							...
							<ul class="dropdown-menu dropdown-menu-custom"
								...
								<li><a class="dropdown-item d-flex justify-content-start"
									href="/Login/logout"><img class="m-1"
										src="/img/icons8-logout-52.png" height="25px" width="25px"
										alt="">
				...
				<button class="navbar-toggler" type="button"
					...
					<img src="/img/icons8-menu-50.png" height="30px" width="30px"
						alt="">
				</button>
			</div>
		</nav>
    ...
    $(document).ready(function() {
        ...
        if (userIsLoggedIn === "true") {
            ...
            // Vô hiệu hóa liên kết "Nhà Tuyển Dụng" và "Ứng Tuyển"
            $('#employers-link').addClass('disabled-link');
            $('#apply-link').addClass('disabled-link');
        } else {
            $('#login-btn').show();
            $('#register-btn').show();
            $('#account-info').addClass('d-none');

            // Kích hoạt lại liên kết nếu chưa đăng nhập
            $('#employers-link').removeClass('disabled-link');
            $('#apply-link').removeClass('disabled-link');
        }
    });
</script>
</body>
